...
void initial_state() {
  ...
  if (kinematics_origin.X_M < 100) {
    calculate_speed();
    kinematics_origin.kinematics_cal();
    current_theta = kinematics_origin.R_M;
    pwm_heading = rotate.update(0, current_theta / 2463.7194);
  ...
  /*else if (kinematics_origin.X_M > 60 && kinematics_origin.X_M < 100){
    calculate_speed();
    kinematics_origin.kinematics_cal();
    current_theta = kinematics_origin.R_M;
    pwm_heading = rotate.update(0, current_theta / 2463.7194);
    //pwm_heading = heading.update(demand_heading, 0);
    pwm_left = spd_pid_left.update(0.24 + pwm_heading, avg_e1_spd);
